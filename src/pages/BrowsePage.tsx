...
import LoadingSpinner from "../presentation/common/components/LoadingSpinner";
...
const mockPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive guide to building scalable APIs with Node.js, Express, and best practices.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-2xl text-gray-700 max-w-3xl mx-auto font-medium leading-relaxed">
              Discover amazing articles and stories from our community of
              writers
            </p>
          </div>
        </div>
