...
import { ArrowRightIcon, SparklesIcon, FireIcon, ClockIcon } from '@heroicons/react/24/outline';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="flex items-center justify-center space-x-4 mb-8">
              ...
              <h2 className="text-5xl lg:text-6xl font-black text-gray-900 tracking-tight">{t('home.featuredPosts')}</h2>
            </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-20">
            <div className="text-center lg:text-left mb-8 lg:mb-0">
              <div className="flex items-center justify-center lg:justify-start space-x-4 mb-6">
                ...
                <h2 className="text-5xl lg:text-6xl font-black text-gray-900 tracking-tight">{t('home.latestPosts')}</h2>
              </div>
              <p className="text-2xl text-gray-700 font-medium">Stay updated with our newest content</p>
            </div>
            <Link
              to="/browse"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="flex items-center justify-center space-x-4 mb-8">
              ...
              <h2 className="text-5xl lg:text-6xl font-black text-gray-900 tracking-tight">{t('home.trendingPosts')}</h2>
            </div>
            <p className="text-2xl text-gray-700 max-w-3xl mx-auto font-medium leading-relaxed">
